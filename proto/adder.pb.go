...
func (x *AddRequest) GetStart() int32 {
	if x != nil {
		return x.Start
	}
	return 0
...
func (x *AddRequest) GetEnd() int32 {
	if x != nil {
		return x.End
	}
	return 0
...
var file_proto_adder_proto_rawDesc = []byte{
	...
	0x6f, 0x74, 0x6f, 0x12, 0x04, 0x67, 0x72, 0x70, 0x63, 0x22, 0x34, 0x0a, 0x0a, 0x41, 0x64, 0x64,
	...
	0x32, 0x35, 0x0a, 0x05, 0x41, 0x64, 0x64, 0x65, 0x72, 0x12, 0x2c, 0x0a, 0x03, 0x41, 0x64, 0x64,
...
var file_proto_adder_proto_depIdxs = []int32{
	0, // 0: grpc.Adder.Add:input_type -> grpc.AddRequest
	1, // 1: grpc.Adder.Add:output_type -> grpc.AddResponse
